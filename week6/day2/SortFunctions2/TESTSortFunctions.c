...
static void TestSelectionSort1000Items()
{
    ADTErr errResult;
	Vector* vec;
    int isSorted;
    ...
    isSorted = CheckIfSortedAscend(vec);
    printf("Sorted: %d, ", isSorted);
    PrintErrResult("TestSelectionSort1000Items", errResult, ERR_OK);
    VectorDestroy(vec);
}
