...
static void TestVectorElementNULLVec()
{
	...
	actionCalledCount = VecForEach(NULL, VectorElementPersonYodofy, yodoString);
...
static void TestVectorElementPersonYodofy()
{
	...
	VecAppend(vec, (void*)&arr[3]);
	VecAppend(vec, (void*)&arr[4]);
	actionCalledCount = VecForEach(vec, VectorElementPersonYodofy, yodoString);
