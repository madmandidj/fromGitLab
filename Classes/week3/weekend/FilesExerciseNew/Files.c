...
int PrintRepeatedStrings(FILE* _fp)
{
        ...
        else
        {
            ...
            while (line[lineIndex] != '\0')
            {
                ...
                if (1 == isStr)
                {
                    ...
                    {
                        /*
                        if (0 == strcmp(string, sFT->m_strArr[i].m_string))
                        {
                            isNewStr = 0;
                            ++sFT->m_freqArr[i];
                        }
                    ...
                    if (1 == isNewStr)
                    {
                         ++strElements;
                        /*
                        strcpy(sFT->m_strArr[strElements-1].m_string, string);
                        ++sFT->m_freqArr[strElements-1];
                        */
    ...
    {
        /*
        printf("%s  %d\n", sFT->m_strArr[i].m_string, sFT->m_freqArr[i]);
        */
