...
static void TestListItrEndEmptyList()
{
    List* list;
    int* arr;
    size_t numOfInts = 10;
    ...
    if (listItr2 == listItr1)
    {
        printf("PASS: TestListItrEndEmptyList\n");
    }
    else
    {
        printf("FAIL: TestListItrEndEmptyList\n");
    }
    ListDestroy(&list, NULL);
    free(arr);
    return;
...
static void TestListItrGetEmptyList()
{
    List* list;
    ListItr listItr;
    int* arr;
    ...
    if (NULL == data)
    {
        printf("PASS: TestListItrGetEmptyList\n");
    }
    else
    {
        printf("FAIL: TestListItrGetEmptyList\n");
    }
    ListDestroy(&list, NULL);
    free(arr);
    return;
...
******/
static void TestListItrPrevNULLItr()
{
    ListItr listItr;
    int* data;

    listItr = ListItrPrev(NULL);
    data = ListItrGet(listItr);
    if (NULL == data)
    {
        printf("PASS: TestListItrPrevNULLItr\n");
    }
    else
    {
        printf("FAIL: TestListItrPrevNULLItr\n");
    }
    return;
}

static void TestListItrPrevBeginItr()
{
    List* list;
    ListItr listItr1;
    ListItr listItr2;
    ...
    listItr2 = ListItrEnd(list);
    if (listItr1 == listItr2)
    {
        printf("PASS: TestListItrPrevBeginItr\n");
    }
    else
    {
        printf("FAIL: TestListItrPrevBeginItr\n");
    }
    ListDestroy(&list, NULL);
    return;
}
...
*/
static void TestListItrNextNULLItr()
{
    ListItr listItr;
    int* data;

    listItr = ListItrNext(NULL);
    data = ListItrGet(listItr);
    if (NULL == data)
    {
        printf("PASS: TestListItrNextNULLItr\n");
    }
    else
    {
        printf("FAIL: TestListItrNextNULLItr\n");
    }
    return;
}
...
int main()
{
    ...
    TestListItrGetEmptyList();
    TestListItrGetEndItr();
    TestListItrGetValue();

    /* LIST ITR PREV */
    TestListItrPrevNULLItr();
    TestListItrPrevBeginItr();
    TestListItrPrevValue();

    /* LIST ITR NEXT */
    TestListItrNextNULLItr();
