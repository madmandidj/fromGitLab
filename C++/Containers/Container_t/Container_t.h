...
//		
//		virtual bool Insert(elementType* const _element, size_t index) = 0;
//		
//		virtual elementType* Remove(elementType const& _element) = 0;
//		
...
//		
//		virtual elementType* Find(elementType const& _element) const = 0;
//		
//		virtual size_t GetElementIndex(elementType* const _element) const = 0;
