...
void TestHeapInsert10Element()
{
    ...
    vec = InitVec10Vals(vec);
    heap = HeapBuild(vec); 
    errResult = HeapInsert(heap, -2);
    errResult = HeapInsert(heap, 20);
    errResult = HeapInsert(heap, 100);
    errResult = HeapInsert(heap, 23);
    errResult = HeapInsert(heap, 120);
    errResult = HeapInsert(heap, 3);
    errResult = HeapInsert(heap, 70);
    errResult = HeapInsert(heap, 40);
    errResult = HeapInsert(heap, 5);
    errResult = HeapInsert(heap, 7);
    HeapPrint(heap);
    PrintErrResult("TestHeapInsert10Element", errResult, ERR_OK);
    HeapDestroy(heap);
    return;
}
