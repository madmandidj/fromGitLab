/*
Filename: 		TESTDoubleLinkedList.c 
Description:	Tests for implementation of DLL API (DoubleLinkedList.c)
Created: 		16/07/17
...
void TestListDestroyTwice()
{
	List* list;
	list = ListCreate();
	ListDestroy(list);
	ListDestroy(list);
	printf("PASSED: TestListDestroyTwice\n");
	return;
}
