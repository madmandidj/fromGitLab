...
// static Person* CheckKeyMultiElement(Person* _head, Person* _prevP, Person* _curP, int _key, Person* _p, int* _cont)
// {
// 	Person* returnP = NULL;
// 	if (_curP == NULL)
// 	{
...
static Person* CheckKeyMultiElement(Person* _head, Person** _prevPP, Person** _curPP, int _key, Person* _p, int* _cont)
{
	Person* returnP = NULL;
	if (*_curPP == NULL)
	{
	...
	{
		(*_prevPP) = (*_prevPP)->m_next;
		*_curPP = (*_curPP)->m_next;
		returnP = _head;
		*_cont = 1;
	}
	return returnP;
...
Person* ListInsertByKey(Person* _head, int _key, Person* _p)
{
	...
	else
	{
		...
		while (cont)
		{
			_head = CheckKeyMultiElement(_head, prevPP, curPP, _key, _p, contP);
			// _head = CheckKeyMultiElement(_head, prevP, curP, _key, _p, contP);
		}
		return _head;
	}
}
