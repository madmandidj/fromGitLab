...
void TestCreateVectorAlloc();
void TestCreateArrayAlloc();

void TestAddVectorNotNull();
void TestAddArrayNotNull();
void TestAddVectorInitialSizeZero();
void TestAddItemEnoughCapacity();
void TestAddItemNotEnoughCapacity();

void TestItemsNumVectorNotNull();
void TestItemsNumArrayNotNull();
void TestItemsNumCorrectSizeZero();
void TestItemsNumCorrect();

void TestGetVectorNotNull();
void TestGetArrayNotNull();
void TestGetItemNotNull();
void TestGetIndexGreaterThanSize();
void TestGetIndexSmallerThanZero();
void TestGetCorrectItemValue();

void TestSetVectorNotNull();
void TestSetArrayNotNull();
void TestSetIndexGreaterThanSize();
void TestSetIndexSmallerThanZero();

void TestDeleteVectorNotNull();
void TestDeleteArrayNotNull();
void TestDeleteItemNotNull();
