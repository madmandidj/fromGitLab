...
#include "queue.h"
/*
	"Queue.c": Implementation of Queue API. 
	Functions: QueueCreate, QueueDestroy, QueueInsert, QueueRemove, QueueIsEmpty, QueuePrint
*/
struct Queue
{
...
void    QueuePrint(Queue* _queue)
{
    ...
    {
        printf("Index: %d Value: %d\n", printIndex, _queue->m_vec[printIndex]);
        ++printIndex;
